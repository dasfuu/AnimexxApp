...
public class RPGNotification extends BaseNotification {
    ...
    public boolean vibrate(Context pContext) {
        return PreferenceManager.getDefaultSharedPreferences(pContext).getBoolean("notifications_new_rpg_message_vibrate", true);
    }

    @Override
    public String getSoundUri(Context pContext) {
        return PreferenceManager.getDefaultSharedPreferences(pContext).getString("notifications_new_rpg_message_ringtone", null);
    }
